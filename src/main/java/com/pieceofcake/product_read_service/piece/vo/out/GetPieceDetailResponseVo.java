...
@Getter
public class GetPieceDetailResponseVo {
    ...
    private GetPieceResponseVo piece;

    @Builder
    public GetPieceDetailResponseVo(String productUuid, GetCategoryResponseVo mainCategory, GetCategoryResponseVo subCategory,
                                    String productName, String description, Long aiEstimatedPrice, String aiEstimatedDescription, List<GetProductImageResponseVo> images, GetPieceResponseVo piece) {
